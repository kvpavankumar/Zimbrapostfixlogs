...
printf "%d,", adj_int_units($msgsDlvrd);
printf "%d,", adj_int_units($msgsFwdd);
printf "%d,", adj_int_units($msgsDfrd);
printf "%d,", adj_int_units($msgsBncd);
printf "%d,", adj_int_units($msgsRjctd);
printf "%d,", adj_int_units($msgsWrnd);
printf "%d,", adj_int_units($msgsHld);
printf "%d,", adj_int_units($msgsDscrdd);
printf "%d,", adj_int_units($sizeRcvd);
printf "%d,", adj_int_units($sizeDlvrd);
printf "%d,", adj_int_units($sendgUserCnt);
printf "%d,", adj_int_units($sendgDomCnt);
printf "%d,", adj_int_units($recipUserCnt);
printf "%d", adj_int_units($recipDomCnt);
